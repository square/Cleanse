...
@objc
public class LegacyObjectGraph: NSObject, LegacyObjectGraphProtocol {
    ...
    @objc(objectForClass:)
    public func objectForClass(cls: AnyClass) -> AnyObject {
        return objectForClass(cls: cls, withName: nil)
    }

    /// Convenience method equivalent to `providerForClass(cls: cls, withName: nil)`
    @objc(providerForClass:)
    public func providerForClass(cls: AnyClass) -> () -> AnyObject {
        return providerForClass(cls: cls, withName: nil)
    }

    /// Convenience method equivalent to `providerForClass(cls: cls, withName: name)()`
    @objc(objectForClass:withName:)
    public func objectForClass(cls: AnyClass, withName name: String?) -> AnyObject {
        return providerForClass(cls: cls, withName: name)()
    }

    @objc
    public func providerForClass(cls: AnyClass, withName name: String?) -> () -> AnyObject {
    ...
    @objc(injectPropertiesIntoObject:)
    public func injectPropertiesIntoObject(object: AnyObject) {
