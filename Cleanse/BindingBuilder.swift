...
public protocol BindingBuilder: BindToable {
    ...
    static var collectionMergeFunc: (([FinalProvider.Element]) -> FinalProvider.Element)? { get }
...
extension BindToable {
    ...
    @discardableResult
    public func to(value: Input,
                   file: StaticString=#file,
                   line: Int=#line,
                   function: StaticString=#function) -> BindingReceipt<Input> {
     ...
     */
    @discardableResult
    public func to(file: StaticString=#file,
                   line: Int=#line,
...
extension BindingBuilder {
    ...
    public func _innerTo(file: StaticString=#file,
                         line: Int=#line,
                         function: StaticString=#function,
        ...
        let anyCollectionMergeFunc: (([Any]) -> Any)?
